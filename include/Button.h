...
const uint8_t MAPA_BOTOES[8] = {
  CHANNEL_LEFT,      // Botão Físico 1: Seleciona Track 1
  CHANNEL_RIGHT,      // Botão Físico 2: Seleciona Track 2
  ASSIGN_PLUGIN,      // Botão Físico 3: Seleciona Track 3
  ASSIGN_PAN,    // Botão Físico 4: Volta os encoders para PAN (Resgate)
  FLIP,          // Botão Físico 5: Inverte Faders com Encoders
  ASSIGN_SEND,     // Botão Físico 6: Modo Equalizador
